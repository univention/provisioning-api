...
* **deps:** Update gitregistry.knut.univention.de/univention/dev/nubus-for-k8s/listener-base/listener-base Docker tag to v0.14.8 ([012920a](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/012920a54e4347215719a1e6f3e18f30f1dd322d)), closes [#0](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/0)
...
* **deps:** Update nubus/images/wait-for-dependency Docker tag to v0.36.6 ([17fdf93](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/17fdf93be52cdff6025720c78ee9a25b63fe9f3e)), closes [#0](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/0)
...
* **provisioning-listener:** Recreate subscription if NATS connection failed ([9a6d6d3](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/9a6d6d38b982bc27906db0b3929f1b573d13d2e7))
* **provisioning-listener:** Recreate subscription if NATS connection failed ([657c65c](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/657c65c328cf04295aa5e57d07ca9b3c8d1ed8f0))
...
* **app:** UCR provisioning-service/log/level=INFO ([1ef3146](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/1ef31464a939e2d005cb2a9659853bb7007ce539)), closes [univention/dev/projects/provisioning#116](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/116)

## [0.68.8](https://git.knut.univention.de/univention/dev/projects/provisioning/compare/v0.68.7...v0.68.8) (2026-01-23)


### Bug Fixes

* **provisioning-listener:** Recreate subscription if NATS connection failed ([8394af6](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/8394af6cc3b96e1c9c6c7c00af5c1501d28bcce6))
...
* Bump image to errata 299 ([b11e1e8](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/b11e1e8dafda2f1b7b72979289f7fa1fc62f1445)), closes [univention/dev/internal/team-nubus#1518](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1518)
...
* **app-backend:** univention/dev/ucs[#2902](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/2902) add backend app ini ([a414102](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/a41410254693fa90019387f283940dda9907e32f))
* **app:** add run-backup-* scripts ([7315d10](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/7315d107e7c7cc626473f6876707487395855aae))
* **app:** retrieve secrets from primary on backup ([04ad0bc](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/04ad0bca2a309a0266a49a81445d1cf9bc649e86))
* **app:** univention/dev/ucs[#2902](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/2902) add app metadata ([b01eb17](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/b01eb170fee1ee6b0f13c098a78e110d7b046f00))
* **app:** univention/dev/ucs[#2902](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/2902) add app metadata basics & upload ([45de65a](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/45de65a4da988730bebf98d8f69a47151cd1d631))
* **app:** univention/dev/ucs[#2902](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/2902) add appcenter scripts ([e07148c](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/e07148c5e687fb25e665d3ece3d6d21afacff922))
* **app:** univention/dev/ucs[#2902](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/2902) add ucr templated compose ([3271c8b](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/3271c8b89367bb3406e0c82dcf649231c4100092))
* **app:** use ucs base image 523 for udm-transformer ([b8bbc1f](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/b8bbc1f2b513482f2adfd4392ce662bfb7e363e0)), closes [univention/dev/projects/provisioning#102](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/102)
* **app:** use ucs base image 523 for udm-transformer ([491b3f4](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/491b3f4077a5accbfa7ce77ecec6fb13a35f9174))
* Downgrade the pydantic version to v1 in the listener to make it installable on UCS 5.2 (Debian Bookworm) ([af057f1](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/af057f19b3cfa5f073edfa9f4df7da0abda664c1)), closes [univention/dev/ucs#2902](https://git.knut.univention.de/univention/dev/ucs/issues/2902)
* **listener:** Clean up dangerous `self.connect` logic that silent fail ([7f8100a](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/7f8100a65a933286580441ea994ef8d060aba373)), closes [univention/dev/projects/provisioning#102](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/102)
* **listener:** remove dependency on the backends python package because it has a transitive dependency on pydantic v2 ([a7b7f06](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/a7b7f0690550085a67d80a5a5bb49fa9484707ae)), closes [univention/dev/ucs#2902](https://git.knut.univention.de/univention/dev/ucs/issues/2902)
* **listener:** univention/dev/ucs[#2902](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/2902) debian packaging of listener module ([e05f455](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/e05f455d6ea83a9a58b6d76ec3b7f2bf20a81b26))
* **listener:** univention/dev/ucs[#2902](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/2902) wrapper for pydantic v1 BaseModel ([dfffc47](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/dfffc47364eb2839d9a40786551d6cdd019e74a8))
* remove backup consumer services ([d032291](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/d0322914b9c19988028093522707aa2ac782bc81)), closes [univention/dev/projects/provisioning#96](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/96)
* remove backup consumer services ([554254e](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/554254e13688f3c1521e396223e4c3aa40a5255d)), closes [univention/dev/projects/provisioning#96](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/96)
* support provisioning service on backup ([d170551](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/d170551205d50a716864fa885441c2bf987b252b))
* univention/dev/ucs[#2902](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/2902) Fix example consumer in ini ([5b33cc5](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/5b33cc550d219af61d46c9df07187d8e5cd08912))
* univention/dev/ucs[#2902](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/2902) Super simple first documentation ([deaaf8e](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/deaaf8eac08ec0847ee9de9328955ae22f875493))


### Bug Fixes

* **app:** add support for ssl/tls & fix pydantic ([cda55e7](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/cda55e743b06f25b1c90bc66f527e3eb19e49769)), closes [univention/dev/projects/provisioning#83](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/83)
* **app:** deactive automatically created portal tile ([5e44a80](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/5e44a8035ab01646f84bfb89b77a599befeb45b0)), closes [univention/dev/projects/provisioning#83](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/83)
* **app:** remove broken debug sections ([002564c](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/002564c081343ddceb2a66717d13c9103ef9466f))
* **app:** rename Stack->Service in description ([5ad7e4a](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/5ad7e4aa3a68dd4ee38c5c60afcef76be62590db))
* **apps/provisioning-service/inst:** add sleep to NATS health check for correct retry/timeout behavior ([a81e5a7](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/a81e5a797d7a713a491f761eb485a1f86143943f))
* **backup-consumer:** fix log message ([3468b11](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/3468b116de517a2f84b4b4cb4139e143273251f0)), closes [univention/dev/projects/provisioning#91](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/91)
* **backup-consumer:** use unique stream name to allow multiple backup nodes ([5513b47](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/5513b4721f268b76f4f852057c48a6cd17dfd1f2)), closes [univention/dev/projects/provisioning#91](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/91)
* **backup-consumer:** use univention owned registry ([1e0d951](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/1e0d9518bd9f2a7c5a075c538cbddcb33d48216f)), closes [univention/dev/projects/provisioning#91](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/91)
* **docker-compose:** add ulimits to ldap-server service to avoid excessive memory usage ([3802f4e](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/3802f4e2f4528805d5ed5b324769c98130e6e2ef))
* **docker-compose:** add ulimits to ldap-server service to avoid excessive memory usage ([49cba50](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/49cba50e5d9d96938d0a49821a96acda0951704b)), closes [univention/dev/projects/provisioning#95](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/95)
* **e2e_test:** fix e2e_settings ([f58964f](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/f58964f09d6933531d3a4fc1cf7d95f36f576820)), closes [univention/dev/projects/provisioning#95](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/95)
* env_suffix does not work in pydantic_BaseSettings ([91b2970](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/91b2970b38ac47352f2cfe7f1bf6a50bfed1285d)), closes [univention/dev/projects/provisioning#96](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/96)
* **helm:** Correctly set new variables in configmap for helm charts ([ae1bb06](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/ae1bb06fc575eadeae2f7b977ced2eeb7ffcb70e)), closes [univention/dev/internal/team-nubus#1527](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1527)
* If the udm transformer cache is empty, fall back to transforming the live event ([5fe37da](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/5fe37daeb7dca823194c6ebf7184a8cb98a5d6ee))
* **ini:** restrict app installation to primary and backup servers ([bb9af71](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/bb9af718248f02496cb12693bc4c728f4713dd06)), closes [univention/dev/projects/provisioning#91](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/91)
* **listener:** add psutil dependency ([23a319a](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/23a319a94c12674e8b3a8131c4c1eb09635c4317)), closes [univention/dev/projects/provisioning#95](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/95)
* **listener:** Make the listener code independent of the common models because they depend on pydantic v2 ([7e5ec62](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/7e5ec62e48782df0b3cfedb27556eb03f71293b7)), closes [univention/dev/ucs#2902](https://git.knut.univention.de/univention/dev/ucs/issues/2902)
* **listener:** univention/dev/ucs[#2902](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/2902) control traceback during the connection to the nats server. ([b3427df](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/b3427dfd19cc8d5cd6e2a60a0519a47299f99ccb))
* New dependencies to UDM needed in the udm-transformer ([abfe155](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/abfe155543df1dfae7dbff64102eaf9f3bc3b673))
* **preinst:** add check to ensure app is installed on primary first and refactor preinst code ([90d6d01](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/90d6d01c1da52fdf3cc01f3cdb75ea36001f687c)), closes [univention/dev/projects/provisioning#91](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/91)
* **provisioning-service-backend:** replaced old ini file ([d25023a](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/d25023a497ef5f09be118cea19461021ddcf0fd4)), closes [univention/dev/projects/provisioning#91](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/91)
* **push_config_to_appcenter:** the upload script needs to handle both apps ([4d6137d](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/4d6137d2493715987c686ae35d82cc04f8ea8e5d)), closes [univention/dev/projects/provisioning#91](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/91)
* remove raise exception that broke the re-connection to nats ([db0fefe](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/db0fefed95c4a5eb56fec0e01e29f9ba919e90ff)), closes [univention/dev/projects/provisioning#96](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/96)
* **run-backup-*.sh:** use correct host names ([2a3ec33](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/2a3ec337e7e543e0cbdc6f0eb509341fb64c859d)), closes [univention/dev/projects/provisioning#91](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/91)
* **run-backup-consumer.sh:** add volume to copy server_role.conf into container ([cd29fa2](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/cd29fa28d5bb7a93ba582b8d2219553c82b6190d))
* **server_role.conf:** remove dependency on server_role.conf file ([5a4c69f](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/5a4c69f65faf189d14edb6b9070924e02149d392)), closes [univention/dev/projects/provisioning#91](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/91)
* set minimum supported UCS version to 5.2-2 ([84059f9](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/84059f9aec5e52770cb5cf3dc8baba2bb6ab9378))
* **tests:** remove test colision with self-service module on ucs ([9ce52e7](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/9ce52e7f7f3d9cf69b8630703327351648b11333)), closes [univention/dev/projects/provisioning#95](https://git.knut.univention.de/univention/dev/projects/provisioning/issues/95)
...
* adjust keyMapping in values for prefill.nats.auth.existingSecret ([7391bd3](https://git.knut.univention.de/univention/dev/projects/provisioning/commit/7391bd39ca487857b98c8aedfd04a5848b8d336b)), closes [univention/dev/internal/team-nubus#1399](https://git.knut.univention.de/univention/dev/internal/team-nubus/issues/1399)
