...
class PasswordRequired(Unauthorized):
    def __init__(self):
        ...
        super(PasswordRequired, self).__init__(
            message, self.status, {"password_required": True}
        )
...
class LDAP_ServerDown(UMC_Error):
    def __init__(self):
        ...
        super(LDAP_ServerDown, self).__init__(
            message, status=503, reason="LDAP Service Unavailable"
        )
