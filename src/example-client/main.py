...
async def main():
    ...
    parser.add_argument("username", help="Consumer username")
    parser.add_argument("password", help="Consumer password")
    ...
    client = shared.client.AsyncClient(args.base_url, args.username, args.password)
