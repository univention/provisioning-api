...
|------------|------|---------|
| oci://gitregistry.knut.univention.de/univention/customers/dataport/upx/nats-helm/helm | nats | 0.2.0 |
...
| global.nats | object | `{"auth":{"admin":{"existingSecret":{"name":null}},"dispatcher":{"existingSecret":{"keyMapping":{"dispatcherPassword":null},"name":null}},"prefill":{"existingSecret":{"keyMapping":{"prefillPassword":null},"name":null}},"provisioningApi":{"existingSecret":{"keyMapping":{"provisioningApiPassword":null},"name":null}},"udmListener":{"existingSecret":{"keyMapping":{"udmListenerPassword":null},"name":null}},"udmTransformer":{"existingSecret":{"keyMapping":{"udmTransformerPassword":null},"name":null}}},"connection":{"host":"","port":""}}` | Define configuration regarding nats connectivity. |
