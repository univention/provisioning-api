...
|------------|------|---------|
| oci://gitregistry.knut.univention.de/univention/customers/dataport/upx/nats-helm/helm | nats | 0.1.1-pre-jlohmer-configurable-affinity |
